...
class GetUnfollowedUseCase:
    ...
    def handle(self, channel_name: str, since: datetime, until: datetime | None = None) -> list[ChannelFollower]:
        return self._followers_repository.list_unfollowed_since(channel_name, since, until)
