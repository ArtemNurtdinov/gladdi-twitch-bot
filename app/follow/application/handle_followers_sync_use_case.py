...
class HandleFollowersSyncUseCase:
    ...
    async def handle(self, db_session_provider: Callable[[], AbstractContextManager[Session]], sync_job: FollowersSyncJobDTO):
        ...
        with db_session_provider() as db:
            ...
            if unfollowed_ids:
                repo.mark_unfollowed(channel_name=sync_job.channel_name, user_ids=unfollowed_ids, unfollowed_at=seen_at)
