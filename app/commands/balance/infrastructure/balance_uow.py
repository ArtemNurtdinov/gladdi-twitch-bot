...
class SqlAlchemyBalanceUnitOfWork(SqlAlchemyUnitOfWorkBase, BalanceUnitOfWork):
...
class SqlAlchemyBalanceUnitOfWorkFactory(SqlAlchemyUnitOfWorkFactory[BalanceUnitOfWork], BalanceUnitOfWorkFactory):
    def __init__(
        self,
