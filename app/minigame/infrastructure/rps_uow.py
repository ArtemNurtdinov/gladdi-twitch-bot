...
class SqlAlchemyRpsUnitOfWork(SqlAlchemyUnitOfWorkBase, RpsUnitOfWork):
...
class SqlAlchemyRpsUnitOfWorkFactory(SqlAlchemyUnitOfWorkFactory[RpsUnitOfWork], RpsUnitOfWorkFactory):
    def __init__(
        self,
    ...
    def _build_uow(self, db: Session, read_only: bool) -> RpsUnitOfWork:
        return SqlAlchemyRpsUnitOfWork(
            session=db,
