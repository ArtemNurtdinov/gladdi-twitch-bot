...
class HandleRpsUseCase:
    def __init__(
        ...
        unit_of_work_factory: RpsUnitOfWorkFactory,
    ):
    ...
    async def handle(
        ...
        user_message = dto.command_prefix + dto.command_name + " " + dto.choice_input
        ...
        if not rps_game_is_active:
            ...
            with self._unit_of_work_factory.create() as uow:
                uow.chat_use_case.save_chat_message(
                    channel_name=dto.channel_name, user_name=dto.user_name, content=user_message, current_time=dto.occurred_at
                )
                uow.chat_use_case.save_chat_message(
                    channel_name=dto.channel_name, user_name=bot_nick, content=message, current_time=dto.occurred_at
                )
            return message
