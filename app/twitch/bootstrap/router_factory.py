...
def build_twitch_command_router(
    ...
    async def roll_handler(chat_ctx: ChatContext, msg: ChatMessage):
        ...
        amount = tail or None
        await registry.roll_command_handler.handle(chat_ctx=chat_ctx, channel_name=chat_ctx.channel,
                                                   display_name=msg.author, amount=amount)
    ...
    async def rps_handler(chat_ctx: ChatContext, msg: ChatMessage):
        ...
        choice = tail or None
        await registry.rps_command_handler.handle(channel_name=chat_ctx.channel, display_name=msg.author,
                                                  chat_ctx=chat_ctx, choice=choice)
