...
from app.platform.infrastructure.api_client import StreamingApiResponse


async def handle_api_response(response: StreamingApiResponse, operation: str, logger: Logger) -> dict[str, Any]:
