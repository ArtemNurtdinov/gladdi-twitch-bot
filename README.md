...
Бот/микросервис для Twitch со встроенным дашбордом. Запускает Twitch‑бота, собирает аналитику по активности чата и отдаёт REST API для просмотра метрик и управления.
