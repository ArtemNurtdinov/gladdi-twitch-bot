...
GLaDDi — бот для Twitch со встроенной админкой. 

Разбавляет чат интерактивными командами, собирает аналитику по активности и предоставляет API для управления и просмотра метрик.
